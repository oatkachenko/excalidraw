...
export declare const actionFinalize: {
    ...
    label: string;
    trackEvent: false;
    perform: (elements: readonly import("../../element/src/types").OrderedExcalidrawElement[], appState: Readonly<AppState>, _: any, app: import("../types").AppClassProperties) => {
        elements: import("../../element/src/types").OrderedExcalidrawElement[] | undefined;
        appState: {
            cursorButton: "up";
